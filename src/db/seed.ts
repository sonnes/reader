...
const seedData = {
  ...
  articles: [
    ...
    },
    {
      ...
      preview:
        'Personal narrative detailing an ALS diagnosis journey and its impact on daily life.',
      content:
    ...
    },
    {
      ...
      preview:
        'How Cursor approaches scaling autonomous coding agents for long-running tasks across large codebases.',
      content:
    ...
    },
    {
      ...
      preview:
        "Safari's latest developer tools update brings powerful visualization for CSS Grid layouts.",
      content:
    ...
    },
    {
      ...
      preview:
        'A deep dive into generating QR codes using nothing but PostgreSQL SQL queries.',
      content:
    ...
    },
    {
      ...
      preview:
        'A community thread where Hacker News users share and discuss their personal websites and portfolios.',
      content:
    ...
    },
    {
      ...
      preview:
        'Furiosa announces their RNGD server claiming 3.5x better efficiency than NVIDIA H100s for AI inference workloads.',
      content:
    ...
    },
    {
      ...
      preview:
        "Why tech compensation isn't a single bell curve, but three distinct distributions based on company type.",
      content:
    ...
    },
    {
      ...
      preview:
        "Technical Program Managers are often misunderstood. Here's what they actually do and when you should hire one.",
      content:
    ...
    },
    {
      ...
      preview:
        'A deep dive into how Stripe builds software, based on interviews with current and former engineers.',
      content:
